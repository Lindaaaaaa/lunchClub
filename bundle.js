...
var UserRow = React.createClass({displayName: "UserRow",
  ...
  render: function() {
    ...
    React.createElement("span", {style: { color: '#ccc'}}, "N/A (co-op)") :
    React.createElement("strong", null, this.props.user.priority);
    return (
        ...
        React.createElement("td", null, React.createElement("strong", null, this.props.user.name)), 
...
render: function() {
    ...
    this.props.users.forEach(function(user, i) {
        rows.push(React.createElement(UserRow, {user: user, key: user.name, removeMember: this.removeMember.bind(this, i), handleUserInput: this.handleUserInput.bind(this,i)}));
    }.bind(this));
    return (
        ...
        React.createElement("th", null, "Captaincy Priority"), 
        React.createElement("th", null, "Attending")
        )
        ), 
        React.createElement("tbody", {id: "tbody"}, rows)
        )
        );
}
});
...
var GreaterUserTable = React.createClass({displayName: "GreaterUserTable",
...
render: function() {
    return (
        ...
        React.createElement("div", {id: "addMember", style: {display: "none"}}, React.createElement("br", null), React.createElement("br", null), "Name:", React.createElement("input", {type: "text", id: "name"}), "  Coop?", React.createElement("input", {type: "checkbox", id: "coop"}), React.createElement("input", {type: "button", value: "Submit", onClick: this.addMember}), React.createElement("br", null), React.createElement("br", null)
        ), React.createElement("br", null), 
        React.createElement("p", {style: {fontSize:12}}, "***DONT FORGET TO SAVE THE LIST!!! OTHERWISE IT WON'T BE OVERWRITTEN!***")
        )
        );
}
});
...
React.createElement(GreaterUserTable, {users: userList}),
